...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  call <sid>X('rustConditional', s:hue_3,    '', 'bold')
  call <sid>X('rustRepeat', s:hue_3,    '', 'bold')
  call <sid>X('rustSelf', s:hue_4,    '', 'italic')
  call <sid>X('rustKeyword', s:hue_5,    '', 'bold')
  call <sid>X('rustMacro', s:hue_3,    '', 'italic')
  call <sid>X('rustTypedef', s:hue_5,    '', 'bold')
  call <sid>X('rustStructure', s:hue_5,    '', 'bold')
  call <sid>X('rustUnsafeKeyword', s:hue_3,    '', 'italic')
  call <sid>X('rustStorage',           s:hue_6_2,    '', 'bold')
  call <sid>X('rustAmperstamp',           s:hue_6_2,    '', 'bold')
  call <sid>X('rustDelimiter',      s:hue_2,              '',          'bold')
  call <sid>X('rustOperator',           s:hue_2,    '', 'bold')
  call <sid>X('rustFatArrowCharacter',           s:hue_2,    '', 'bold')
  call <sid>X('rustSheBang',           s:hue_2,    '', 'bold')
